        ...
        <Box direction="row" gap="medium" pad="medium" justify="center">
            <Card height="small" width="small" background="light-1">
                <CardHeader pad="medium">
                    <Heading margin="none" level="3" textAlign="textAlign">Time remaining</Heading></CardHeader>
                <CardBody pad="medium">
            ...
            <Card height="small" width="small" background="light-1">
                <CardHeader pad="medium">
                    <Heading margin="none" level="3" textAlign="textAlign">Time elapsed</Heading></CardHeader>
                <CardBody pad="medium">
